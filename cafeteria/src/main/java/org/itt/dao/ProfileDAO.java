...
public class ProfileDAO {
    ...
    public void addOrUpdateProfile(Profile profile) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            String query = "INSERT INTO Profile (userId, foodPreference, spiceLevel, cuisinePreference, sweetTooth) " +
                    "VALUES (?, ?, ?, ?, ?) " +
                    "ON DUPLICATE KEY UPDATE foodPreference = VALUES(foodPreference), " +
